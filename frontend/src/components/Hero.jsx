          ...
          <div className="flex flex-wrap gap-3 mb-10">
            ...
            {p.github_url && (
              <a 
                ...
                rel="noreferrer" 
                aria-label="GitHub"
                className="grid size-11 place-items-center rounded-xl border border-line bg-panel/30 text-slate hover:text-white hover:bg-[#24292F] hover:border-[#24292F] hover:shadow-[0_0_15px_rgba(36,41,47,0.3)] transition-all duration-300"
              >
            ...
            {p.linkedin_url && (
              <a 
                ...
                rel="noreferrer" 
                aria-label="LinkedIn"
                className="grid size-11 place-items-center rounded-xl border border-line bg-panel/30 text-slate hover:text-white hover:bg-[#0077B5] hover:border-[#0077B5] hover:shadow-[0_0_15px_rgba(0,119,181,0.3)] transition-all duration-300"
              >
            ...
            {p.leetcode_url && (
              <a 
                ...
                rel="noreferrer" 
                aria-label="LeetCode"
                className="grid size-11 place-items-center rounded-xl border border-line bg-panel/30 text-slate hover:text-white hover:bg-[#FFA116] hover:border-[#FFA116] hover:shadow-[0_0_15px_rgba(255,161,22,0.3)] transition-all duration-300"
              >
                <svg className="w-[17px] h-[17px] fill-current" viewBox="0 0 24 24">
            ...
            {p.gfg_url && (
              <a 
                ...
                className="grid size-11 place-items-center rounded-xl border border-line bg-panel/30 text-slate hover:text-white hover:bg-[#2F8D46] hover:border-[#2F8D46] hover:shadow-[0_0_15px_rgba(47,141,70,0.3)] transition-all duration-300"
              >
                <svg className="w-[17px] h-[17px] fill-current" viewBox="0 0 24 24">
            ...
            <a 
              ...
              className="grid size-11 place-items-center rounded-xl border border-line bg-panel/30 text-slate hover:text-white hover:bg-gradient-to-tr hover:from-[#f9ce34] hover:via-[#ee2a7b] hover:to-[#6228d7] hover:border-transparent hover:shadow-[0_0_15px_rgba(238,42,123,0.35)] transition-all duration-300"
            >
              <svg className="w-[18px] h-[18px] fill-current" viewBox="0 0 24 24">
            ...
            {p.email && (
              <a 
                href={`mailto:${p.email}`} 
                aria-label="Email"
                className="grid size-11 place-items-center rounded-xl border border-line bg-panel/30 text-slate hover:text-white hover:bg-blue hover:border-blue hover:shadow-[0_0_15px_rgba(59,130,246,0.35)] transition-all duration-300"
              >
                <svg className="w-[18px] h-[18px] fill-current" viewBox="0 0 24 24">
            ...
            {p.resume_url && (
              <a 
                ...
                rel="noreferrer" 
                aria-label="Resume"
                className="grid size-11 place-items-center rounded-xl border border-line bg-panel/30 text-slate hover:text-white hover:bg-[#10b981] hover:border-[#10b981] hover:shadow-[0_0_15px_rgba(16,185,129,0.35)] transition-all duration-300"
              >
                <svg className="w-[17px] h-[17px] fill-current" viewBox="0 0 24 24">
